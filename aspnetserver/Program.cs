...
app.UseSwaggerUI(swaggerUIOptions =>
{
    ...
    swaggerUIOptions.SwaggerEndpoint("/swagger/v1/swagger.json", "Web API serving a very simple Room model.");
...
app.MapGet("/get-room-by-id/{roomId}", async (int roomId) =>
    {
...
app.MapRoom("/create-room", async (Room roomToCreate) =>
{
